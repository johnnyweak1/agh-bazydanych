...
,(
	...
	'Allan',
	'Duda',
	'Kielce ul.S≥owiaÒska 88 79-507',
	'512432132'
)
,(
	3,
	'Alojzy',
	'Kwiatkowski',
	'Zielona GÛra ul.KiliÒskiego 26 50-087',
	'933823110'
)
,(
	4,
...
,(
	...
	'Kacper',
	'Rutkowski',
	'PiotrkÛw Trybunalski ul.Akacjowa 97 77-645',
	'452897123'
)
,(
	6,
...
-- 6d. wyswietl pracownikow, ktorych pierwsza litera imienia zaczyna siÍ na litere J

SELECT pracownicy.imie, pracownicy.nazwisko 
FROM ksiegowosc.pracownicy 
WHERE pracownicy.imie LIKE 'J%';

-- 6e. wyswietl pracownikow, ktorych naziwko zawiera litere 'n' oraz imie konczy siÍ na litere 'a'

SELECT pracownicy.imie, pracownicy.nazwisko 
FROM ksiegowosc.pracownicy 
WHERE pracownicy.nazwisko LIKE '%n%' AND pracownicy.imie LIKE '%a';

-- 6f. wyswietl imie i nazwisko pracownikow oraz liczbe ich nadgodzin przyjmujπc iø standardowy czas pracy to 160h miesiecznie
...
-- 6h. wyúwietl imiÍ i nazwisko pracownikÛw, ktÛrzy pracowali w nadgodzinach i nie otrzymali premii
